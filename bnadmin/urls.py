...
urlpatterns = [
    ...
    path("offers/edit/<uuid:offer_id>/", views.edit_offer, name="edit_offer"),
    path(
        "offers/toggle-status/<uuid:offer_id>/",
        views.toggle_offer_status,
        name="toggle_offer_status",
    ),
    path("offers/delete/<uuid:offer_id>/", views.delete_offer, name="delete_offer"),
